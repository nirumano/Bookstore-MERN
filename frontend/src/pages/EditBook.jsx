...
export const EditBook = () => {
  ...
  return (
    <div className='p-4'>
      <BackButton/>
      <h1 className='text-3xl my-4'>Edit Book:  {book.title}</h1>
      {loading ? <Spinner/> : ''}
      <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>
        ...
        <button className='p-2 bg-yellow-600 m-8 w-full mx-auto text-white' onClick={handleEditBook}>Update</button>
      </div>
    </div>
  )
